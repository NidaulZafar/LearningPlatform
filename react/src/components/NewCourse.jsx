...
const NewCourse = () => {
  ...
  const addVideo = (moduleIndex) => {
    ...
    modules[moduleIndex].videos.push({
      ...initialCourseData.modules[0].videos[0],
    });
    setCourseData({ ...courseData, modules });
  };
        ...
        <div className="new-course-form">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {courseData.modules.map((module, moduleIndex) => (
              <div className="module" key={`module-${moduleIndex}`}>
                ...
                <div className="form-group">
                  <label htmlFor={`module-duration-${moduleIndex}`}>
                    Duration:
                  </label>
                  <input
                    type="number"
                ...
                <div className="form-group">
                  <label htmlFor={`module-content-${moduleIndex}`}>
                    Content:
                  </label>
                  <textarea
                  ...
                  <div key={`video-${moduleIndex}-${videoIndex}`}>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        value={video.title}
                        onChange={(e) =>
                          handleVideoDataChange(moduleIndex, videoIndex, e)
                        }
                        required
                      />
                    </div>
                    <div className="form-group">
                      <label
                        htmlFor={`video-video_url-${moduleIndex}-${videoIndex}`}
                      >
                    ...
                    <div className="form-group">
                      <label
                        htmlFor={`video-thumbnail-${moduleIndex}-${videoIndex}`}
                      >
                        Thumbnail:
                      </label>
                      <input
                    ...
                    <div className="form-group">
                      <label
                        htmlFor={`video-content-${moduleIndex}-${videoIndex}`}
                      >
                        Content:
                      </label>
                      <textarea
